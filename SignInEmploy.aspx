<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignInEmploy.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.SignInEmploy" %>
...
<body>
     <form id="form1" runat="server">
                        ...
                        <ul class ="nav navbar-nav navbar-right">
                             ...
                             <li ><a href="About.aspx">ABOUT</a></li>
                              <li ><a href="ContactUs.aspx">Contact US</a></li>
                                ...
                                <li ><a href="RegisterEmployee.aspx">SignUp</a></li>
                             <li  class="active"><a href="SignInEmploy.aspx">SignIn</a></li>
                        </ul>
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-md-2"></div>
                     <div class="col-md-6">
                         ...
                         <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/RegisterEmployee.aspx">Sign Up</asp:HyperLink>
        ...
        <footer >
        <div class="container">
            <p class="pull-right"><a href="SignInEmploy.aspx">Back to top</a></p>
            <p>&copy;2022 e-commerce Shop.in &middot &middot  <a href="SignInEmploy.aspx">HOME </a>&middot &middot <a href="#">ABOUT</a>&middot &middot <a href="#">CONTACT US</a>&middot &middot <a href="#">PRODUCTS</a>&middot &middot </p>
        </div>
